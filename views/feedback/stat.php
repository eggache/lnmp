...
<div class="tabbable"> <!-- Only required for left/right tabs -->
    <ul class="nav nav-tabs">
        <li class="active"><a href="/feedback/stat?type=1">初审</a></li>
        <li><a href="/feedback/stat?type=2">复审</a></li>
        <li><a href="/feedback/stat?type=3">复核</a></li>
    </ul>
</div>
        ...
        <?php
            foreach($list as $value) {
                ...
                echo '<tr><td style="text-align: center;">'.$checkperson.'</td>',
                    ...
                    '<td style="text-align: center;">'.number_format($picban*100/$piccnt, 2).'%</td>';
                echo '<td style="text-align: center;">'.$textcnt.'</td>',
                    '<td style="text-align: center;">'.number_format($textban/$textcnt, 2).'%</td>';
                echo '<td style="text-align: center;">'.($textcnt+$piccnt).'</td>',
                    '<td style="text-align: center;">'.number_format(($textban+$picban)/($textcnt+$piccnt), 2).'%</td></tr>';
            }
?>
    <tbody>
    </tbody>
